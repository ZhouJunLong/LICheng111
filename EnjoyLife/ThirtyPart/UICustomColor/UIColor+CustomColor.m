...
+ (UIColor *)danziColor{
    return [UIColor colorWithRed:255/255.0f green:240/255.0f blue:245/255.0f alpha:1];
}

+ (UIColor *)silverColor{
    return [UIColor colorWithRed:192/255.0f green:192/255.0f blue:192/255.0f alpha:1];
}
