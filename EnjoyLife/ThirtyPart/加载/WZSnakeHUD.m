...
+ (void)show:(NSString *)text {
    ...
    [WZSnakeHUD showWithBackgroundColor:[UIColor colorWithRed:red / 255 green:green / 255 blue:bule / 255 alpha:1]];
...
+ (NSArray *)hudColors {
    if (!objc_getAssociatedObject(self, _cmd)) {
        self.hudColors = @[[UIColor redColor], [UIColor yellowColor], [UIColor blueColor]];
    }
    return objc_getAssociatedObject(self, _cmd);
}
